...
- **Section 1 (Abstract)**: Add `Figure_1.1_System_Architecture.png`
- **Section 4 (Literature Survey)**: No image needed
- **Section 6 (System Architecture)**: Add `Figure_1.1_System_Architecture.png` and `Figure_6.2_Modules_Diagram.png`
- **Section 7 (Implementation)**: Add `Figure_7.1_Workflow_Diagram.png`
- **Section 8 (Testing)**: Add screenshots of test results (create your own)
- **Section 9 (Results)**: Add performance charts and output screenshots
- **Section 11 (Future Scope)**: Add `Figure_7.1_Workflow_Diagram.png`
